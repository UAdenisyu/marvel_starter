const Spinner = () => {
    return (
        <svg xmlns="http://www.w3.org/3000/svg" style={{margin: '0 auto', background: 'none', display: 'block'}} width="200px" height="200px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
